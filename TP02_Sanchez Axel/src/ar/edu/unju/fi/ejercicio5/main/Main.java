...
public class Main {
	...
	private static void precargarProductos(List<Producto> productos) {
		Producto p1=new Producto("01", "Microondas", 530f, Origenes.ARGENTINA, Categorias.ELECTRO_HOGAR, true);
		Producto p2=new Producto("02", "Martillo", 20f, Origenes.BRASIL, Categorias.HERRAMIENTAS, false);
		...
		Producto p5=new Producto("05", "TV", 120f, Origenes.ARGENTINA, Categorias.ELECTRO_HOGAR, false);
		...
		Producto p10=new Producto("10", "Hacha", 900f, Origenes.BRASIL, Categorias.HERRAMIENTAS, false);
		...
		Producto p13=new Producto("13", "Calefactor", 299f, Origenes.ARGENTINA, Categorias.ELECTRO_HOGAR, true);
		Producto p14=new Producto("14", "Soldador", 412f, Origenes.BRASIL, Categorias.HERRAMIENTAS, true);
		Producto p15=new Producto("15", "Samsung", 397f, Origenes.CHINA, Categorias.INFORMATICA, false);
		productos.add(p1);
		productos.add(p2);
		productos.add(p3);
		productos.add(p4);
	...
	private static void realizarCompra(List<Producto> productosDisponibles, boolean valido, Scanner sc) {
		...
		while(option!=4){
			do {
				...
				System.out.print("2- Pago Efectivo -10% de descuento\n");
				System.out.print("3- Pago con Tarjeta +15% de recarga\n");
